...
import (
	...
	cf "university_circles/service/home_service/config"
	"university_circles/service/home_service/handler"
	pb "university_circles/service/home_service/pb/home"
	"university_circles/service/home_service/utils/logger"
	"university_circles/service/home_service/wrapper"
)
...
func main() {
	...
	// Register Handler
	err = pb.RegisterHomeServiceHandler(service.Server(), new(handler.HomeHandler))
	if err != nil {
