...
import (
	...
	cf "university_circles/service/im_service/config"
	"university_circles/service/im_service/handler"
	pb "university_circles/service/im_service/pb/im"
	"university_circles/service/im_service/utils/logger"
	"university_circles/service/im_service/wrapper"
)
...
func main() {
	...
	// Register Handler
	err = pb.RegisterImServiceHandler(service.Server(), new(handler.ImHandler))
	if err != nil {
