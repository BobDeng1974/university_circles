...
func (q uStudentQuery) One(ctx context.Context, exec boil.ContextExecutor) (*UStudent, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "im: failed to execute a one query for university_student")
	}
...
func (q uStudentQuery) All(ctx context.Context, exec boil.ContextExecutor) (UStudentSlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "im: failed to assign all query results to UStudent slice")
	}
...
func (q uStudentQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "im: failed to count university_student rows")
	}
...
func (q uStudentQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "im: failed to check if university_student exists")
	}
...
func FindUStudent(ctx context.Context, exec boil.ContextExecutor, iD uint, selectCols ...string) (*UStudent, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "im: unable to select from university_student")
	}
...
func (o *UStudent) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("im: no university_student provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "im: unable to insert into university_student")
	}
	...
	if err != nil {
		return errors.Wrap(err, "im: unable to populate default values for university_student")
	}
...
func (o *UStudent) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("im: unable to update university_student, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to update university_student row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "im: failed to get rows affected by update for university_student")
	}
...
func (q uStudentQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to update all for university_student")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to retrieve rows affected for university_student")
	}
...
func (o UStudentSlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to update all in uStudent slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to retrieve rows affected all in update all uStudent")
	}
	return rowsAff, nil
}
...
func (o *UStudent) Upsert(ctx context.Context, exec boil.ContextExecutor, updateColumns, insertColumns boil.Columns) error {
	if o == nil {
		return errors.New("im: no university_student provided for upsert")
	}
	...
	if !cached {
		...
		if len(update) == 0 {
			return errors.New("im: unable to upsert university_student, could not build update column list")
		}
	...
	if err != nil {
		return errors.Wrap(err, "im: unable to upsert for university_student")
	}
	...
	if err != nil {
		return errors.Wrap(err, "im: unable to retrieve unique values for university_student")
	}
...
func (o *UStudent) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("im: no UStudent provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to delete from university_student")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "im: failed to get rows affected by delete for university_student")
	}
...
func (q uStudentQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("im: no uStudentQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to delete all from university_student")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "im: failed to get rows affected by deleteall for university_student")
	}
...
func (o UStudentSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "im: unable to delete all from uStudent slice")
	}
...
func (o *UStudentSlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "im: unable to reload all in UStudentSlice")
	}
...
func UStudentExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "im: unable to check if university_student exists")
	}
